...
# staff/team roles
CAPTAIN_ROLE_ID = 1497062204510306375
CO_CAPTAIN_ROLE_ID = 1506034670565855363
EXECUTIVE_ROLE_ID = 1506034577846566964
TEAM_PLAYER_ROLE_ID = 1497062202698367077
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="CML Transactions Bot – Command Guide",
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="CML Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the CML FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        "# Comp mountians League Frequently Asked Questions\n\n"
        ...
        "> - We will use <#1497062216560545893> to update you on our team situation! We pick the best teams we can from out forms, so make sure you are active and competitive!\n"
